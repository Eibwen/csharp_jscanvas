...
public void CanvasWrapperTest()
{
	using (Bitmap b = new Bitmap(150, 200))
	using (Graphics g = Graphics.FromImage(b))
	{
		...
		{
			//CanvasWrapperTest_LineTo(ctx);
			//CanvasWrapperTest_ArcSmile(ctx);
			//CanvasWrapperTest_Arcs(ctx);
			//CanvasWrapperTest_Arcs2(ctx);
			//CanvasWrapperText_QuadricCurve(ctx);
			//CanvasWrapperTest_Heart(ctx);
			//CanvasWrapperTest_PacManSolo(ctx);
			CanvasWrapperTest_PacMan(ctx);
		}
